          ...
          <Reveal className="md:col-span-4 flex md:justify-end" delay={0.15}>
            <MagneticLink>
              <Link
                ...
                className="group relative inline-flex items-center gap-3 px-8 py-5 border border-florida-oak font-mono text-[13px] tracking-[0.24em] uppercase text-pivot-black overflow-hidden"
              >
